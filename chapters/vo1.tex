...
\begin{equation}
\begin{array}{l}
\left( {1 - u} \right){y^2} - u.{x^2} - y.\cos \left\langle b,c \right \rangle + 2.u.x.y.\cos \left\langle a,b \right \rangle  + 1 = 0 \\
\left( {1 - w} \right){x^2} - w.{y^2} - x.\cos \left\langle a,c \right \rangle + 2.w.x.y.\cos \left\langle a,b \right \rangle  + 1 = 0.
\end{array}
\end{equation}
